...
use noloong_agent::{
    AgentPluginDeclaration, FileEditToolPolicy, Locale, ManifestPatch, SqliteDatabaseLocation,
};
...
mod tests {
    ...
    fn profile_config_path_resolver_prefers_explicit_path() {
        let path =
            resolve_profile_config_path_with_env(Some("~/custom.jsonc"), |name| match name {
                "HOME" => Some("/home/alice".into()),
