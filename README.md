...
On macOS, packaged builds are generated by Tauri rather than by a custom bundle helper. The app identity lives in `crates/noloong-app/tauri.conf.json`, with product name `Noloong`, bundle identifier `com.noloong.desktop`, and the checked-in Noloong icon assets.
